...
/**
 * A factory for creating DavProcessStrategy objects.
 * 
...
public final class DavProcessStrategyFactory {
    ...
    /**
     * Instantiates a new dav process strategy factory.
     */
    private DavProcessStrategyFactory() {
    }

    /**
     * Creates a new DavProcessStrategy object.
     * 
     * @param context
     *            the context
     * @param params
     *            the params
     * @return the generic file process strategy< dav resource>
     */
    public static GenericFileProcessStrategy<DavResource> createGenericFileProcessStrategy(
	...
	boolean isMove = moveExpression != null || preMoveExpression != null
		|| moveFailedExpression != null;
    ...
    /**
     * Gets the exclusive read lock strategy.
     * 
     * @param params
     *            the params
     * @return the exclusive read lock strategy
     */
    @SuppressWarnings("unchecked")
    private static GenericFileExclusiveReadLockStrategy<DavResource> getExclusiveReadLockStrategy(
	    Map<String, Object> params) {
	GenericFileExclusiveReadLockStrategy<DavResource> strategy = (GenericFileExclusiveReadLockStrategy<DavResource>) params
	...
	if (ObjectHelper.isNotEmpty(readLock)) {
		...
		Boolean fastExistsCheck = (Boolean) params
			.get("fastExistsCheck");
