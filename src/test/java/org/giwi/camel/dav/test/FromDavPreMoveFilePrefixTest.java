 ...
 */
public class FromDavPreMoveFilePrefixTest extends AbstractDavTest {

	protected String getDavUrl() {
		return DAV_URL + "/movefile?consumer.delay=5000&preMove=done/${file:name}";
	}
	...
	public void testPollFileAndShouldBeMoved() throws Exception {
		...
		File file = new File(DAV_ROOT_DIR + "/movefile/done/hello.txt");
