...
public class DavBrowsableEndpointTest extends AbstractDavTest {
	...
	BrowsableEndpoint browse = context.getEndpoint(getDavUrl(),
	...
	DavEndpoint<?> endpoint = context.getEndpoint(getDavUrl(),
		DavEndpoint.class);
	assertNotNull(endpoint);

	MemoryIdempotentRepository repo = (MemoryIdempotentRepository) endpoint
	...
	DavEndpoint<?> endpoint = context.getEndpoint(getDavUrl()
		+ "?sortBy=file:name", DavEndpoint.class);
	assertNotNull(endpoint);
	...
	DavEndpoint<?> endpoint = context.getEndpoint(getDavUrl()
		+ "?recursive=true&sortBy=file:name", DavEndpoint.class);
	assertNotNull(endpoint);
