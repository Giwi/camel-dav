...
/**
 * The Class FromDavSimpleNoEndpointPathRelativeMoveToRelativeTest.
 * 
 * @version
 */
public class FromDavSimpleNoEndpointPathRelativeMoveToRelativeTest extends
	AbstractDavTest {
	...
	return DAV_URL
		+ "?recursive=true&move=.done&initialDelay=2500&delay=5000";
    }
	...
	mock.expectedFileExists(DAV_ROOT_DIR + "/sub/.done/bye.txt");
	mock.expectedFileExists(DAV_ROOT_DIR + "/sub/sub2/.done/goodday.txt");
