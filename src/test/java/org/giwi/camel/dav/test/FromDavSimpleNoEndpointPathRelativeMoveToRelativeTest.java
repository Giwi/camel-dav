 ...
 * @version
 */
public class FromDavSimpleNoEndpointPathRelativeMoveToRelativeTest extends AbstractDavTest {

	protected String getDavUrl() {
		return DAV_URL + "?recursive=true&move=.done&initialDelay=2500&delay=5000";
	}
