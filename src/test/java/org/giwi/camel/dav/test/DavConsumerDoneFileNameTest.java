...
public class DavConsumerDoneFileNameTest extends AbstractDavTest {
	...
	public void testDoneFileName() throws Exception {
		...
		// write the done file
		template.sendBodyAndHeader(getDavUrl(), "", Exchange.FILE_NAME, "hello.dat");
		...
		File file = new File(DAV_ROOT_DIR + "done/hello.dat");
	...
	protected RouteBuilder createRouteBuilder() throws Exception {
		return new RouteBuilder() {
			...
			public void configure() throws Exception {
				from(getDavUrl() + "&doneFileName=${file:name.noext}.dat").convertBodyTo(String.class).to("mock:result");
			}
		};
	}
