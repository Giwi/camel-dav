 ...
 */
public class FromDavMoveFileTest extends AbstractDavTest {

	protected String getDavUrl() {
		return DAV_URL + "/movefile?move=done/sub2/${file:name}.old&consumer.delay=5000";
	}
	...
	public void testPollFileAndShouldBeMoved() throws Exception {
		...
		mock.expectedFileExists(DAV_ROOT_DIR + "/movefile/done/sub2/hello.txt.old");
