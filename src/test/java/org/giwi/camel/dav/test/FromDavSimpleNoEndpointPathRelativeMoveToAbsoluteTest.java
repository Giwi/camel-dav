...
/**
 * The Class FromDavSimpleNoEndpointPathRelativeMoveToAbsoluteTest.
 * 
 * @version
 */
public class FromDavSimpleNoEndpointPathRelativeMoveToAbsoluteTest extends
	AbstractDavTest {
	...
	mock.expectedFileExists(DAV_ROOT_DIR + "/.done/bye.txt");
	mock.expectedFileExists(DAV_ROOT_DIR + "/.done/goodday.txt");
